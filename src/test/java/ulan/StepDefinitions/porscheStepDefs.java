...
import ulan.Pages.PorscheHomePage;
import ulan.utilities.BrowserUtilities;
import ulan.utilities.Configuration;
import ulan.utilities.Driver;

public class porscheStepDefs {
    WebDriver driver = Driver.getDriver();
    PorscheHomePage porschePages = new PorscheHomePage();
    ...
    public void user_select_model(int arg1) throws Throwable {
